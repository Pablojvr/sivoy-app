export const EL_SALVADOR_LOCATIONS: { [departamento: string]: string[] } = {
  "Ahuachapán": [
  ...
  "Cabañas": [
    "Cinququera", "Dolores", "Guacotecti", "Ilobasco", "Jutiapa", "San Isidro",
  ...
  "Chalatenango": [
    ...
    "La Laguna", "La Palma", "La Reina", "Las Flores", "Las Vueltas", "Nombre de Jesús",
  ...
  "La Libertad": [
    ...
    "Huizúcar", "Jayaque", "Jicalapa", "La Libertad", "Santa Tecla", "Nuevo Cuscatlán",
  ...
  "La Paz": [
    ...
    "San Rafael Obrajuelo", "Santa María Ostuma", "Santiago Nonualco", "Tapalhuaca", "Zacatecoluca"
  ],
  "La Unión": [
    "Anamorós", "Bolívar", "Concepción de Oriente", "Conchagua", "El Carmen",
    "El Sauce", "Intipucá", "La Unión", "Lislique", "Meanguera del Golfo",
    "Nueva Esparta", "Pasaquina", "Polorós", "San Alejo", "San José", "Santa Rosa de Lima",
...
export const DEPARTAMENTOS_EL_SALVADOR: string[] = Object.keys(EL_SALVADOR_LOCATIONS).sort();
