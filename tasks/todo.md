...
- [ ] T46 Separar superficie pública y operativa; endurecer HTTP y pool.
  - Spec en ejecución: `tasks/specs/T46-http-pool-boundary.md`. T46a configura límites y timeout de adquisición. T46b1 expone cierre idempotente del pool con pruebas RED→GREEN; T46b2 integración con señales pendiente. T46c: el usuario aprobó desactivar temporalmente las escrituras de empresas y puntos solo en producción; las cuatro rutas están inventariadas, sin login por ahora.
